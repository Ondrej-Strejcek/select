...
const Input: React.RefForwardingComponent<InputRef, InputProps> = (
  ...
  inputNode = React.cloneElement(inputNode, {
    ...
    'aria-owns': activeDescendantId === null ? null : `${id}_list`,
    'aria-autocomplete': 'list',
    'aria-controls': activeDescendantId === null ? null : `${id}_list`,
    'aria-activedescendant': activeDescendantId ? activeDescendantId : null,
    ...attrs,
